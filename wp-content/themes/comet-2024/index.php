<!DOCTYPE html>
<!-- language_attributes() added in html starting tag -->
<html lang="<?php language_attributes(); ?>">
  
    <head>
        <!-- <title>Comet | Creative Multi-Purpose HTML Template</title> -->
        <!-- bloginfo('charset') added in meta charset  -->
        <meta charset="<?php bloginfo('charset');?>">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

        <!-- added stylesheets & javascript dynamically with functions.php -->

        <!-- wp_head() added in before the head tag ends  -->
        <?php wp_head(); ?>
    </head>

    <!-- body_class() added in body start tag  -->
    <body <?php body_class(); ?> >
        <div id="loader">
        <div class="centrize">
            <div class="v-center">
        ...
        <!-- added javascript or jquery dynamically with functions.php -->

        <!-- wp_footer() added in before the body tag ends  -->
        <?php wp_footer(); ?>
    </body>
</html>